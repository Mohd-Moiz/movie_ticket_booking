...
export default function Signup(props) {
  ...
  const handleSubmit = (event) =>
  {
   event.preventDefault()
    ...
    const conpassword=document.getElementById("retypepassword").value;
  ...
  return (<>
    <div>
      <div style={{ paddingTop: "70px", padding: "85px", background: "url(https://images.theconversation.com/files/178400/original/file-20170717-6046-6io9ig.jpg?ixlib=rb-1.1.0&q=15&auto=format&w=754&h=503&fit=crop&dpr=3)", backgroundSize: "cover", backgroundAttachment: "fixed" }}>
        <form  onSubmit={(e)=>{ handleSubmit(e); props.toggle();}} style={{ minWidth: "450px", maxWidth: "400px", width: "100%", margin: " 160px auto", padding: "25px", borderRadius: "25px", border: "1px solid grey", backgroundColor: "whitesmoke", opacity: "0.9" }}>
